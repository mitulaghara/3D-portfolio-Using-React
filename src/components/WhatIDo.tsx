        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Specializing in the MERN stack to deliver robust backend systems 
                and dynamic front-end interfaces. I turn complex logic into 
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build the visual layers of modern web applications using 
                cutting-edge libraries like React, Framer Motion, and Tailwind, 
                ensuring every interaction is smooth and responsive.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
